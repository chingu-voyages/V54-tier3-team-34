const persona =
  "Senior technical documentation specialist; Background in software engineering; Experienced in creating clear; concise documentation for complex technical products; Skilled at translating technical concepts for diverse audiences";

const context =
  "Documenting a new machine learning API for a startup developing predictive analytics software; Target audience includes software developers, data scientists, and technical managers; API is relatively new and lacks comprehensive documentation; Company wants to attract early adopters and facilitate quick integration";
