  ...
  return (
    <>
      ...
      <div className="absolute top-2 right-2 text-white cursor-pointer">
        ...
        <div className="pointer-events-none absolute right-5 z-100 min-w-[300px] bg-green-500 p-3 text-sm tracking-wider opacity-0 transition-all peer-hover:opacity-100">
          {placeholder}
        </div>
      </div>
      <label
