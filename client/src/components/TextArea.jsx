...
export default function TextArea({
  ...
  return (
    <>
      ...
      {/* tooltip */}
      <div
        className={`font-paragraph bg-primary-green pointer-events-none absolute bottom-46 right-3 z-100 min-h-18 rounded-lg p-3 tracking-wider opacity-0 transition-all peer-hover/tooltip:opacity-100 ${tooltip && "opacity-100"}`}
      >
        {description}
